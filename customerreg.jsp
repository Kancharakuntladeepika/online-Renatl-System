		  ...
		  <form action="customerregact.jsp" method="post" ><center>
					  <table width="567">
                        ...
                        <tr>
                          ...
                          <td>
                          <input type="text" pattern="[7-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaing 9 digit with 0-9" id="mobile" name="mobile" required class="text" placeholder="Mobile"/></td>
                        </tr>
                        <tr>
